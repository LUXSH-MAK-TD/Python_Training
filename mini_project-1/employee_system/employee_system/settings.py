...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'employee_system', 'static')]

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-#boet#+ziz#!z#jt_fi0&uzoilgs#$))kk)6vh&xf%#qdfes#p'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'employee_system', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
